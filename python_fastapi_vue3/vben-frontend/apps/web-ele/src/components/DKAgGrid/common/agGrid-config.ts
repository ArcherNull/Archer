 ...
 * @LastEditTime: 2025-06-04 10:43:35
 * @Description: ag-grid 基本配置
 */
import type { ExcelStyle, GridOptions } from 'ag-grid-community';
...
export const GRID_OPTIONS: GridOptions = {
  ...
  // grandTotalRow: 'bottom', // 合计行位置，需要在字段设置 aggFunc: "sum"
  groupSelectsChildren: false, // 选中子级
  groupSelectsFiltered: false, // 勾选行组只获取子级数据
  ...
  rowHeight: 45, // 设置行高为30px,默认情况下25px
