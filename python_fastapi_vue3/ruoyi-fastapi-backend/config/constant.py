...
LastEditTime: 2025-04-06 16:49:57
Description: 
'''
...
class GenConstant:
    ...
    COLUMNTYPE_STR = (['character varying', 'varchar', 'character', 'char']
                      if DataBaseConfig.db_type == 'postgresql' else
                      ['char', 'varchar', 'nvarchar', 'varchar2'])
    COLUMNTYPE_TEXT = (['text', 'citext']
                       if DataBaseConfig.db_type == 'postgresql' else
