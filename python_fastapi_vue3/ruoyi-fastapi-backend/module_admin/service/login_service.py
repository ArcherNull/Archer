...
class LoginService:
    ...
    def __generate_user_router_menu(cls, permission_list: List[MenuTreeModel]):
        ...
        for permission in permission_list:
            ...
            router.order_num=permission.order_num
            ...
            router.menu_type=MenuConstant.TYPE_DIR if isinstance(router.children, list) and len(router.children) else MenuConstant.TYPE_MENU
