...
class StringUtil:
    ...
    @classmethod
    def contains_any_ignore_case(cls, search_str: str,
    ...
    @classmethod
    def equals_any_ignore_case(cls, search_str: str,
                               compare_str_list: List[str]):
        """
        ...
        if search_str and compare_str_list:
            return any([
                cls.equals_ignore_case(search_str, compare_str)
                for compare_str in compare_str_list
            ])
        return False
    ...
    def startswith_any_case(cls, search_str: str, compare_str_list: List[str]):
        ...
        if search_str and compare_str_list:
            return any([
                cls.startswith_case(search_str, compare_str)
                for compare_str in compare_str_list
            ])
        return False
    ...
    @classmethod
    def get_mapping_value_by_key_ignore_case(cls, mapping: Dict[str, str],
                                             key: str) -> str:
        """
        根据忽略大小写的键获取字典中的对应的值
