...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__57CE034",
    appName: "uniapp_watermark",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"uniapp_watermark","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 179 */
/*!**************************************************************!*\
  !*** E:/blqc-project/Archer/uniapp_watermark/utils/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _typeof2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/typeof */ 13));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _objectWithoutProperties2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/objectWithoutProperties */ 180));
var _excluded = ["canvasId", "watermarkList"];
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
// 百度AK
var BAIDU_AK = '百度BAIDU_AK';
// 百度客户端id
...
function addWatermarkAndCompress(options, that) {
  ...
  return new Promise(function (resolve, reject) {
    var _dealWatermarkConfig2 = dealWatermarkConfig(options),
    ...
    if (!errLog.length) {
      var canvasId = config.canvasId,
        imagePath = config.imagePath,
        watermarkList = config.watermarkList,
        _config$quality2 = config.quality,
        quality = _config$quality2 === void 0 ? 0.6 : _config$quality2;
      uni.getImageInfo({
        // 获取图片信息，以便获取图片的真实宽高信息
        src: imagePath,
        success: function success(info) {
...
function getLocationByWxH5() {
  var jweixin = __webpack_require__(/*! jweixin-module */ 182);
  return new Promise(function (resolve, reject) {
    if (jweixin) {
      var ruleObj = {
        appId: '公众号的appId',
      ...
      var errLog = validateObj(data, ruleObj);
      if (errLog.length) {
        showMsg(errLog.join(';'));
        reject(false);
      } else {
...
var objectWithoutPropertiesLoose = __webpack_require__(/*! ./objectWithoutPropertiesLoose.js */ 181);
...
/* 182 */
/*!****************************************************************************************!*\
  !*** E:/blqc-project/Archer/uniapp_watermark/node_modules/jweixin-module/lib/index.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
