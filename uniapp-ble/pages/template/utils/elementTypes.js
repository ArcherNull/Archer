...
export var TEMPLATE_ICONS = {
	zoomIn: '/static/icon/zoom-in.png',
	zoomOut: '/static/icon/zoom-out.png',
	undo: '/static/icon/undo.png',
	redo: '/static/icon/redo.png',
	delete: '/static/icon/delete.png',
	list: '/static/icon/list.png',
	move: '/static/icon/move.png',
	fold: '/static/icon/fold.png',
	expand: '/static/icon/expand.png',
	preview: '/static/icon/preview.png',
	command: '/static/icon/code.png',
	importIcon: '/static/icon/import.png',
	print: '/static/icon/print.png',
	settings: '/static/icon/settings.png',
	image: '/static/icon/image.png',
	barcode: '/static/icon/barcode.png',
	qrcode: '/static/icon/qrcode.png',
	text: '/static/icon/text.png',
	hline: '/static/icon/hline.png',
	vline: '/static/icon/vline.png',
	box: '/static/icon/box.png',
	tip: '/static/icon/tip.png',
	help: '/static/icon/help.png',
	lock: '/static/icon/lock.png',
	unlock: '/static/icon/unlock.png',
}
