 ...
 * @LastEditTime: 2024-07-31 17:10:29
 * @Description:  字典表
 */
...
module.exports = (router) => {
  ...
  /**
   * @swagger
   * /api/dictionary/batchGetByValues:
   *   post:
   *     description: 批量获取绑定字典数据通过无父级id以及特殊value
   *     summary: " 批量获取绑定字典数据"
   *     tags: [字典模块]
   *     parameters:
   *       - name: ids
   ...
   *         description: 获取数据列表
   */
  router.get(getUrl("/batchGetByValues"), DictionaryController.getMultiDictItemsByValues);
