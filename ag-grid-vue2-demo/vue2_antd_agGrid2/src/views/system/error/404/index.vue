<template>
  <div class="Error404Page-container" flex="main:center cross:center">
    <div class="Error404Page" flex="main:center ">
      <div class="pic-404">
...
export default {
  ...
  data () {
    return {
      message: '请检查页面路径是否正确，或者向管理员确认页面是否授权',
      interval: null, // 定时器
      timeNum: 15
    }
  },
